...
Juego::Juego(){
    //std::cout<<"pilina"<<std::endl;
    creaElementos();
    //std::cout<<"pilinb"<<std::endl;
    creaComandos();
    //std::cout<<"pilinc"<<std::endl;
}
